...
//     const fetchData = async () => {
//       const result = fetch(ONLINE_URL)
//       .then(data => data.json()).then(data => {
//         setTimeout( () => {
//           RatingChart.preload()
//           console.log('loading')
        
//           setHotels(data.list.slice(0, 10)); //dodaje dane do stanu hotels
//           // setChartData(prepareChartData(data.list.slice(0, 10)))
//           setIsLoading(false);
//         }, 2000)
//       });
...
//     fetchData();
//   }, []);
//   // const filteredHotels = applyFilter(filtersState, hotels)
//   const filteredHotels= useMemo(()=>{
//     return applyFilter(filtersState, hotels)
//   }, [filtersState, hotels]);
//   //co to jest useMemo ? najpierw stawdza czy zmianiaja sie dane zamim zada pytanie do api
//   const sortedHotels= useMemo(()=>{
//    return applySort(filteredHotels, sortVal)
//   }, [filteredHotels, sortVal])

//   const handleChangeFilter=(value, checked)=>{
//     // 1 znienianie stanu np. {SINGLE: false}
//     setFiltersState(prevState=> ({...prevState, [value]: checked}))
//   }
//   const noop = () => {
//     // setChartVisible({chartVisible: !this.state.chartVisible});
//   };
//   const toggleChartVisibility=(chartVisible)=>{
//        //zmiana stanu visibleChart
...
//   return (
//     <Container>
//       <SortBar sortField={sortVal} setField={handleChangeSort} />
//       <Layout>
//         <Layout.Sidebar>
//           <ChartSwitcher isChartVisible={chartVisible}  switchChartVisible={toggleChartVisibility}/>
    
//           <Filters count={countHotelsByBedType(filteredHotels)} onChange={handleChangeFilter}  />
//         </Layout.Sidebar>
//         <Layout.Feed isLoading={isLoading}>
//           {chartVisible && (
//           <React.Suspense fallback={<Loader active inline="centered" />}>
